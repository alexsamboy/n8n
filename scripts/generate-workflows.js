...
const activities=[...byId.values()].filter(a=>new Date(a.endAt||a.startAt)>=new Date(cfg.referenceDate)).sort((a,b)=>a.startAt.localeCompare(b.startAt)||a.title.localeCompare(b.title,'es')||a.id.localeCompare(b.id));
